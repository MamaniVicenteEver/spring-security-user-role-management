...
/**
 * Filtro para la autenticación y autorización de las solicitudes mediante tokens JWT.
 * Este filtro intercepta cada solicitud y valida los tokens JWT para establecer la autenticación.
 */
@Component
public class JwtFilter extends OncePerRequestFilter {
    ...
    /**
     * Método para realizar la lógica de filtrado de cada solicitud HTTP.
     *
     * @param request     El objeto HttpServletRequest.
     * @param response    El objeto HttpServletResponse.
     * @param filterChain El objeto FilterChain para el encadenamiento de filtros.
     * @throws ServletException Si ocurre un error durante la ejecución del filtro.
     * @throws IOException      Si ocurre un error de entrada/salida durante la ejecución del filtro.
     */
    @Override
